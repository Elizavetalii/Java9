...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageList.setOnItemClickListener((parent, view, position, id)->{
            ...
            Intent intent = new Intent(MainActivity.this, Full_image_activity.class);
    ...
    private Uri saveImageStorage(Bitmap bitmapImage){
        File outputDirectiory = getApplicationContext().getCacheDir();
        File imageFile = new File(outputDirectiory, System.currentTimeMillis()+".jpg");
